...
int main()
{
    int val1,val2 {0};                                                // Initialize both integer variabile to 0
    ...
    if (val2 != 0)
    { 
        if (val1 % val2 != 0) cout << "Warning! We are working with integer values. To deal with this causistry you should use double data type." << endl; 
        else cout << "The ratio is : " << val1 / val2 << endl;
    }
